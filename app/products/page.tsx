  ...
  const products = [
    {
      ...
      description:
        "High-precision injection molding solutions for complex geometries and demanding applications with advanced temperature control.",
      features: [
        '±0.001" tolerance',
    ...
    },
    {
      ...
      description:
        "Advanced compression molding for thermoset materials and high-strength applications with precise pressure control.",
      features: [
        "Temperature control",
        "Pressure monitoring",
        "Cycle optimization",
    ...
    },
    {
      ...
      description:
        "State-of-the-art blow molding technology for hollow plastic products with exceptional wall thickness control.",
      features: [
    ...
    },
    {
      ...
      description:
        "Fully automated assembly lines with precision robotics and advanced AI-powered quality assurance systems.",
      features: [
    ...
    },
    {
      ...
      description:
        "Intelligent conveyor systems with adaptive speed control and integrated sorting capabilities.",
      features: [
    ...
    },
    {
      ...
      description:
        "High-speed pick and place automation with vision guidance and precision positioning technology.",
      features: [
    ...
    },
    {
      ...
      description:
        "AI-powered quality control and inspection systems for comprehensive product validation and defect detection.",
      features: [
    ...
    },
    {
      ...
      description:
        "Precision coordinate measuring machines with advanced software for complex part verification.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive material testing solutions for strength, durability, and performance validation.",
      features: [
        "Tensile testing",
        "Impact testing",
        "Fatigue analysis",
    ...
    },
    {
      ...
      description:
        "Specialized tooling and fixtures designed for your unique manufacturing requirements with rapid prototyping.",
      features: [
        "CAD/CAM design",
        "Rapid prototyping",
        "Material selection",
    ...
    },
    {
      ...
      description:
        "Comprehensive process analysis and optimization services to maximize efficiency and reduce operational costs.",
      features: [
        "Workflow analysis",
        "Cost reduction",
        "Efficiency gains",
    ...
    },
    {
      ...
      description:
        "Complete system integration services connecting all manufacturing components into unified workflows.",
      features: [
        "System integration",
        "Data connectivity",
        "Workflow automation",
    ...
    <>
      ...
      <section className="pt-24 pb-16 bg-gradient-mesh relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          ></div>
          <div
            className="absolute top-1/2 left-1/2 w-64 h-64 bg-slate-500/10 rounded-full blur-3xl animate-float"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center" data-animation="fade-in-up">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8">
              Discover our comprehensive range of precision manufacturing
              solutions, automation systems, and custom engineering services
            ...
            >
              {specifications.map((spec, index) => (
                <div
                  key={index}
                  className={`glass-card rounded-lg p-4 text-center stagger-${
                    index + 1
                  }`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12" data-animation="fade-in-up">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Explore our comprehensive range of manufacturing solutions
          ...
          >
            {categories.map((category, index) => (
              <button
                ...
                className={`group flex items-center space-x-3 px-8 py-4 rounded-2xl font-medium transition-all duration-300 hover-lift stagger-${
                  index + 1
                } ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProducts.map((product, index) => (
              <div
                key={product.id}
                data-animation="scale-in"
                className={`bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group border border-slate-200 hover:border-slate-300 hover-lift stagger-${
                  (index % 6) + 1
                } flex flex-col`}
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  {/* Hover Overlay */}
                  <div
                    className={`absolute inset-0 bg-slate-900/80 flex items-center justify-center transition-opacity duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-animation="fade-in-up">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Our manufacturing solutions power innovation across diverse
              industries, from automotive to aerospace, medical devices to
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              ...
              <div
                key={index}
                data-animation="bounce-in"
                className={`text-center p-6 rounded-2xl bg-slate-50 hover:bg-slate-100 transition-all duration-300 group hover-lift stagger-${
                  index + 1
                }`}
              >
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-1/3 left-1/4 w-64 h-64 bg-slate-600/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-animation="fade-in-up">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Cutting-edge technology and expertise that sets us apart in the
            ...
            {[
              {
                ...
                description:
                  'Tolerances down to ±0.0001" with state-of-the-art machining centers and measurement systems.',
                metric: '0.0001"',
                label: "Tolerance",
              },
              {
                ...
                description:
                  "Quick turnaround times from concept to production-ready prototypes using advanced 3D printing.",
                metric: "24-48hrs",
                label: "Turnaround",
              },
              {
                ...
                description:
                  "ISO 9001:2015 certified processes ensuring consistent quality and traceability.",
                metric: "99.8%",
                label: "Quality Rate",
              },
              {
                ...
                description:
                  "Tailored manufacturing solutions for unique project requirements and specifications.",
                metric: "500+",
              ...
              <div
                ...
                className={`glass-card rounded-2xl p-8 text-center group hover-lift hover-glow stagger-${
                  index + 1
                }`}
              >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-animation="fade-in-up">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Cutting-edge technologies that power our manufacturing excellence
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div data-animation="fade-in-left">
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-8">
                Our advanced AI systems optimize production processes in
                real-time, predicting maintenance needs, quality issues, and
                efficiency improvements before they impact your operations.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-animation="fade-in-up">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              ...
              process ensures exceptional results at every stage.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Detailed project analysis and requirement gathering with our engineering team.",
                  icon: Target,
                  duration: "1-2 days",
                },
                {
                  ...
                  description:
                    "CAD design development and rapid prototyping for validation and testing.",
                  icon: Settings,
                  duration: "3-5 days",
                },
                {
                  ...
                  description:
                    "Tooling preparation, machine programming, and quality system configuration.",
                  icon: Cog,
                  duration: "1-2 weeks",
                },
                {
                  ...
                  title: "Manufacturing",
                  description:
                    "Full-scale production with continuous monitoring and quality assurance.",
                  icon: Factory,
                  duration: "2-4 weeks",
                },
                {
                  ...
                  description:
                    "Comprehensive testing, inspection, and certification before delivery.",
                  icon: Shield,
                  duration: "2-3 days",
                },
                {
                  ...
                  description:
                    "Secure packaging, delivery, and ongoing technical support services.",
                  icon: Truck,
                  duration: "1-2 days",
                },
              ].map((process, index) => (
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div data-animation="scale-in">
            ...
            <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto">
              Join hundreds of companies who trust Moldcraft for their most
              critical manufacturing needs. Let's discuss how we can elevate
